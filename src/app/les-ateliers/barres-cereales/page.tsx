...
const defaultAtelier = {
  ...
  title: "Barres de céréales",
  headline: "Fabrique tes propres barres de céréales !",
  description:
    "Découvre les gestes des pâtissiers, apprends à mélanger les ingrédients, cuire et assembler tes barres, puis repars avec ta création personnalisée.",
  ...
  priceDuo: "39,90 €",
  longDescription:
    "**Déroulé de l'atelier**\nAccueil dans l'atelier des aventuriers : découverte des ingrédients et des ustensiles de cuisine.\nChoix des ingrédients : les apprentis cuisiniers sélectionnent céréales, fruits secs et saveurs.\nPréparation des barres : mélange, cuisson et assemblage des ingrédients.\nPersonnalisation et finitions : décoration et emballage de tes barres de céréales.",
  reviews: [
    {
    ...
    },
    {
      ...
      text: "2ème expérience pour mon fils de 10 ans, barres de céréales la 1ere fois et maroquinerie la 2ème. Il a adoré apprendre et découvrir, très bien encadré avec beaucoup de pédagogie et de patience, bref, une super expérience pour lui permettre de faire !",
      span: "lg:col-span-6",
    },
  ],
};

export default function BarresCerealesPage() {
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 px-6 py-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-10">
            ...
            <p className="mt-6 text-sm text-zinc-700">
              Partez à l'aventure dans le monde de la cuisine avec les Ducs. Ceux-ci ont fixé
              aux participants un nouveau défi : fabriquer de véritables barres de céréales,
              saines et personnalisées, prêtes à accompagner les explorateurs de Djogo dans leurs quêtes gourmandes !
            </p>
