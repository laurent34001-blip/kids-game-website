...
const defaultAtelier = {
  ...
  headline: "Crée ton propre tableau en peinture au couteau !",
  description:
    "Découvre la technique de la peinture au couteau, apprends à mélanger les couleurs et à créer des textures, puis repars avec ta création personnalisée.",
  ...
  priceDuo: "39,90 €",
  longDescription:
    "**Déroulé de l'atelier**\nAccueil dans l'atelier des aventuriers : découverte des techniques et des outils de la peinture.\nChoix des couleurs et design : les apprentis artistes sélectionnent leurs couleurs et imaginent leur composition.\nTechnique du couteau : apprentissage du geste et application de la peinture à l'aide du couteau.\nPersonnalisation et finitions : ajout de touches finales et création de textures pour un tableau unique.",
  reviews: [
    {
    ...
    },
    {
      ...
      text: "2ème expérience pour mon fils de 10 ans, peinture couteau la 1ere fois et maroquinerie la 2ème. Il a adoré apprendre et découvrir, très bien encadré avec beaucoup de pédagogie et de patience, bref, une super expérience pour lui permettre de faire !",
      span: "lg:col-span-6",
    },
  ],
};

export default function PeintureCouleauPage() {
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 px-6 py-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-10">
            ...
            <p className="mt-6 text-sm text-zinc-700">
              Partez à l'aventure dans le monde de l'art avec les Ducs. Ceux-ci ont fixé
              aux participants un nouveau défi : créer un véritable tableau en peinture
              au couteau, riche en couleurs et en textures, prêt à accompagner les explorateurs
              de Djogo dans leurs quêtes créatives !
            </p>
