...
const defaultAtelier = {
  ...
  headline: "Construis ta propre chaîne de dominos en bois !",
  description:
    "Découvre comment assembler et faire tomber une chaîne de dominos en bois ! Apprends à équilibrer, aligner et personnaliser tes dominos, puis repars avec ta création prête à s'effondrer.",
  ...
  priceDuo: "39,90 €",
  longDescription:
    "**Déroulé de l'atelier**\nAccueil dans l'atelier des aventuriers : découverte des dominos et des techniques de construction.\nChoix des modèles : les apprentis constructeurs imaginent formes et motifs.\nMontage de la chaîne : placement, alignement et tests de chute.\nPersonnalisation et finitions : décoration et emballage pour emporter ta chaîne de dominos.",
  reviews: [
    {
    ...
    },
    {
      ...
      text: "2ème expérience pour mon fils de 10 ans, dominos en bois la 1ere fois et maroquinerie la 2ème. Il a adoré apprendre et découvrir, très bien encadré avec beaucoup de pédagogie et de patience, bref, une super expérience pour lui permettre de faire !",
      span: "lg:col-span-6",
    },
  ],
};

export default function Les28DominosEnBoisPage() {
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 px-6 py-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-10">
            ...
            <p className="mt-6 text-sm text-zinc-700">
              ...
              aux participants un nouveau défi : fabriquer de véritables dominos en bois,
